<footer class="text-white text-sm">
    <div
        class="relative bg-gradient-to-br from-[#1e3a8a]/95 to-[#2563eb]/90 border-t border-white/10 backdrop-blur-md shadow-lg overflow-hidden">
        ...
        <div class="relative z-10 px-5 py-6 max-w-7xl mx-auto">
            <div
                class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 text-center md:text-left">
                <!-- Link Navigasi -->
