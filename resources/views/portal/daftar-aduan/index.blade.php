            ...
            <div class="relative overflow-hidden w-full"
                ...
                <form method="GET" action="{{ route('daftar-aduan') }}"
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-xl transition leading-none">
