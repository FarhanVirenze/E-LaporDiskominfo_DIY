                        ...
                        <form action="{{ route('report.lacak') }}" method="POST"
                            ...
                            <input type="text" name="tracking_id" placeholder="Nomor Tiket Aduan"
                                class="w-full md:flex-1 px-6 py-3 border border-blue-800 bg-white/90 rounded-full shadow 
                                                                                                                                    ...
                                                                                                                                    text-base text-center font-semibold tracking-wider transition duration-300"
                                required>

                            <button type="submit"
                                class="relative overflow-hidden mt-2 bg-gradient-to-br from-[#0D47A1] to-[#1976D2] 
                                                                                                                            text-white font-bold px-8 py-3 rounded-full tracking-wide shadow 
                                                                                                                            transition-all duration-200 group">

                                <span class="relative z-10">Lacak</span>
                                <span
                                    class="absolute inset-0 bg-black opacity-20 group-hover:opacity-30 transition-opacity duration-200"></span>
                            </button>
                        </form>
                    </div>
                </div>
                    ...
                    <div id="carouselContainer" class="overflow-x-auto overflow-y-hidden scroll-smooth scrollbar-hide mt-6">
                        <div id="carouselItems" class="flex">
                            @foreach ($reports as $report)
                                @php
                                    $defaultImage = asset('images/images.jpg');
