        ...
        <div class="hidden lg:block relative h-[96vh] overflow-hidden">
            ...
            <div
                ...
                <div class="w-full flex justify-center px-4 mb-8">
                    <div class="inline-flex items-center gap-3 px-8 py-3 min-w-[320px] rounded-lg
                    border border-yellow-300 bg-gradient-to-r from-yellow-50 to-yellow-100 
                    shadow-lg text-center">
                        ...
                        <!-- Text -->
                        <div>
                            <p class="text-base sm:text-lg font-semibold text-yellow-800 tracking-wide">
