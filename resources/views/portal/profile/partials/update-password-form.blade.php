        ...
        <div class="flex items-center gap-4">
            ...
            @if (session('status') === 'password-updated')
                <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 4000)" x-show="show"
                    ...
                    class="fixed bottom-6 right-6 z-50 max-w-sm w-full bg-blue-100 border border-blue-300 text-blue-800 text-sm rounded-lg shadow-lg px-4 py-3 flex items-start"
                    role="alert">
