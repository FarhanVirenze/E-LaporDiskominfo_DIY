<x-app-layout>
    ...
    <div class="p-6 space-y-6">
        {{-- Tombol Tambah Agenda (Admin saja) --}}
        ...
        <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow">
            <table class="min-w-full text-sm text-left text-gray-800 dark:text-gray-200 border-separate border-spacing-y-2">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-4 py-2">
                                @if($agenda->approved_by)
                                    <span title="Disetujui pada {{ \Carbon\Carbon::parse($agenda->approved_at)->format('d M Y H:i') }}">
                            ...
                            <td class="px-4 py-2 text-center space-x-1">
                                ...
                                @if($user->role === 'admin')
                                    <a href="{{ route('agendas.edit', $agenda->id_agenda) }}"
                                        class="inline-block px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white rounded text-xs font-medium">
                                        Edit
                                    </a>
                                ...
                                {{-- Semua role: Detail --}}
                                <a href="{{ route('agendas.show', $agenda->id_agenda) }}"
                                    class="inline-block px-3 py-1 bg-gray-600 hover:bg-gray-700 text-white rounded text-xs font-medium">
                                    Detail
                                </a>
                            </td>
                        </tr>
