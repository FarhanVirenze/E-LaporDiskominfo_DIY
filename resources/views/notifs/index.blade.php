            ...
            <table class="min-w-full table-auto">
                ...
                <tbody class="text-gray-700 dark:text-gray-200 text-sm">
                    @forelse($notifs as $notif)
                        ...
                        {{ $notif->status === 'terbaca' ? 'bg-green-500 text-white' : 'bg-red-500 text-white' }}">
                                        ...
                                        <td class="py-3 px-6 text-center space-x-2">
                                            @if(auth()->user()->role === 'admin')
                                                ...
                                                <form action="{{ route('notifs.destroy', $notif->id_notif) }}" method="POST"
                                                    class="inline-block"
                                            ...
                                            @if(auth()->user()->role === 'user')
                                                <a href="{{ route('notifs.show', $notif->id_notif) }}"
