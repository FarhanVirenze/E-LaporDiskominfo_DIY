...
@section('content')
    <div class="container mt-4">
        <div class="d-flex align-items-center mb-4">
            <h1 class="fw-bold text-dark mb-0 font-weight-bold">Kelola Admin Kategori</h1>
        </div>
                ...
                @foreach($admins as $admin)
                    <div class="card border-0 mb-3 shadow-sm rounded-4"
                        ...
                        <div class="card-body p-3">
                            ...
                            <div id="form-mobile-{{ $admin->id_user }}" class="kategori-form mt-3" style="display: none;">
                        ...
                        @foreach($admins as $index => $admin)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div id="form-desktop-{{ $admin->id_user }}" class="kategori-form mt-3" style="display: none;">
                                        <form method="POST"
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Notifikasi fade out dengan animasi smooth
            setTimeout(() => {
